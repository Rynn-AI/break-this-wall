...
const messages = [
    "tap dimana aja ya, bcz im gonna break this wall",
    "hi nan, we're just friend right?..",
    "yang suka mabar roblox sampe tengah malem..",
    "discord sampai tengah malam..",
    "Honestly, it was fun, and I don't wanna ruin it..",
    "And to the point— I like you.",
    "baca yang di wa dulu ya.. kalau udah di baca coba pencet tombol dibawah ini 💝,"
];
